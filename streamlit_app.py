...
def _json_schema_instruction() -> str:
    return (
        ...
        "  \"date_iso\": \"YYYY-MM-DD\","
        "  \"opening_summary\": \"Fix My Call: Thank you for submitting a call for review. Below, you will find feedback broken downinto three categories, and your reviewing trainer’s overall feedback is provided at the end.\","
        "  \"sections\": ["
        "    {"
        ...
        "  \"recommended_materials\": [\"List of recommended Sales Fix materials (titles or URLs) with short descriptions of each. New paragraph for each.\"],"
        "  \"overall_score\": 55,"
